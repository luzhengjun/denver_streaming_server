...
Denver Streming Server is a streaming software based on Linux platform. The expected inputs of this software are video files encoded with h.264, h.265, vp9, etc. The output is a ts muxed udp/multicast stream, without changing video/audio formats.<br />
